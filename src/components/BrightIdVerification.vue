          ...
          <v-col class="">
            ...
            <v-row>
              <v-col class="text-center">
                <v-btn
                  v-if="!brightIdContextId"
                  elevation="0"
                  class="rounded-sm mt-6 py-3 px-6 text-body-1 font-weight-medium"
                  color="primary"
          ...
          <v-col class="text-center">
            <a
              ...
              ><img
                ...
                src="@/assets/verification/googlePlay.svg"
            /></a>
            <a
              class="mx-2"
              ...
              ><img
                ...
                height="48px"
                alt="Get it on Google Play"
                src="@/assets/verification/appStore.svg"
            /></a>
            <v-btn
              :disabled="!brightIdContextId"
              x-large
              elevation="0"
      ...
      <v-card-text class="text-black" v-if="brightIdStep === 2">
        ...
        <v-row class="mt-5">
          <v-col class="d-flex justify-center">
            <qr-code
              :text="`brightid://link-verification/http:%2F%2Fbrightid2.idealmoney.io/Muon/${brightIdContextId}`"
            ></qr-code>
          </v-col>
        </v-row>
        <v-row>
        ...
        <v-row>
          <v-col class="text-center">
            <v-btn
              x-large
              elevation="0"
              class="rounded-sm mt-2 py-4 px-15 text-h6"
              color="primary"
