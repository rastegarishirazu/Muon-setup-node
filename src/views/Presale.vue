<template>
  <v-main>
    ...
    <v-row v-else-if="preslaeStep === 1" justify="center" style="height: 100%">
    ...
    <v-row v-else-if="preslaeStep === 2" justify="center" style="height: 100%">
      <v-col cols="10" align-self="center" class="text-center">
        <img width="84px" src="@/assets/verification/Wallet.svg" alt="" />
        <v-row class="mt-5">
          <v-col cols="2" class="px-0">
          ...
          <v-col class="pl-0">
            <p class="text-18 font-weight-regular text-left">
              Go to your wallet and select the address you used for the presale.
              If this is the same address you're currently using for the Alice
              dashboard, skip this step
            </p>
          </v-col>
        </v-row>
        <v-row>
    ...
    <v-row v-else-if="preslaeStep === 3" justify="center" style="height: 100%">
      <v-col cols="10" align-self="center" class="text-center">
        <img width="84px" src="@/assets/verification/Wallet.svg" alt="" />
        <v-row class="mt-5">
          <v-col>
    ...
    <v-row v-else-if="preslaeStep === 4" justify="center" style="height: 100%">
      <v-col cols="10" align-self="center" class="text-center">
        <v-badge
          bottom
          color="green"
        ...
        <p class="text-18 font-weight-regular mt-10">
          Congratulations! <br />
          You passed Presale participants verification Your access granted to
          run Alice Starter node
        </p>
    ...
    <v-row v-else-if="preslaeStep === 5" justify="center" style="height: 100%">
      <v-col cols="10" align-self="center" class="text-center">
        <v-badge
          bottom
          color="red"
        ...
        <p class="text-18 font-weight-regular mt-10">
          Sorry, this address is not among the presale participants. Please try
          a different verification method or connect to another wallet
        </p>
